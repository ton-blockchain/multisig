...
export type ActionSet = Array<Action>;
...
export function endParse(slice: Slice): void {
...
export class Multisig implements Contract {
  ...
  static packOrder(actions: Array<Action>): Cell {
  ...
  async getMultisigData(provider: ContractProvider): Promise<{
